  ...
  return (
    <Modal transparent visible={visibility}>
      <View style={{backgroundColor:"rgba(255,255,255,0.96)",flex:1}}>
         <TouchableOpacity onPress={()=>closemodal()} style={{backgroundColor:"red",marginLeft:20,marginTop:40,width:40,height:40,borderRadius:20,backgroundColor:colors.green,display:"flex",justifyContent:"center",alignItems:"center"}}>
